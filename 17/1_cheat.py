# copied from: https://www.reddit.com/r/adventofcode/comments/18k9ne5/comment/ke1kgjv/?utm_source=share&utm_medium=web2x&context=3
...
def main():
    assert day17('17/test.txt') == 102
    print(f"Part 1: {day17('17/input.txt')}")

    assert day17('17/test.txt', True) == 94
    print(f"Part 2: {day17('17/input.txt', True)}")
